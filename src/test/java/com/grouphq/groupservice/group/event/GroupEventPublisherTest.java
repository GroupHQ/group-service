package com.grouphq.groupservice.group.event;

import static org.mockito.BDDMockito.given;
import static org.mockito.Mockito.verify;

import com.grouphq.groupservice.group.domain.outbox.OutboxEvent;
import com.grouphq.groupservice.group.domain.outbox.OutboxRepository;
...
class GroupEventPublisherTest {
    ...
    void retrieveDeleteThenPublishMessages() {
        ...
        StepVerifier.create(groupEventPublisher.publishProcessedEvents().get())
